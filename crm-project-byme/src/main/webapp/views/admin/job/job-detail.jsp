                ...
                <div class="row">
                    <div class="col-xs-12">
                    	<a href="#" class="group-title">
                            <img width="30" src='<c:url value="/template/admin/plugins/images/users/pawandeep.jpg" />' class="img-circle" />
                            ...
                            <c:forEach items="${listJob}" var="item">
                                ...
                                <a href="#">
                                    <div class="mail-contnet">
                                        <h5>${item.userModel.fullName}</h5> <span class="mail-desc">${item.content}</span> <span
